...
public class AppointmentController {
    ...
    // Create / Update
    @PostMapping
    public ResponseEntity<Appointment> save(@Valid @RequestBody Appointment appointment) { // <-- FIXED PARAMETER SPELLING
        // FIX: Replaced apointment.getPatientId() with the correct way to get the ID from the Appointment model
